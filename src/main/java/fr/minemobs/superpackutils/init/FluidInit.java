...
public class FluidInit {
    ...
    public static final FluidObject SILICON_TETRACHLORIDE = register("silicon_tetrachloride", new Color(65, 86, 140), FLUID_RL);
    public static final FluidObject CHLOROFORM = register("chloroform", new Color(94, 65, 140), FLUID_RL);
    public static final FluidObject CHLOROMETHANE_MIXTURE = register("chloromethane_mixture", new Color(170, 113, 255), FLUID_RL);
    public static final FluidObject CUMENE = register("cumene", new Color(190, 207, 157), FLUID_RL);
    public static final FluidObject ACETONE = register("acetone", new Color(188, 227, 162), FLUID_RL);
    public static final FluidObject SODIUM_CHLORIDE = register("sodium_chloride", new Color(117, 155, 252), FLUID_RL);
    ...
    public static final FluidObject SODIUM_HYDROXIDE = register("sodium_hydroxide", new Color(29, 168, 141), FLUID_RL);
    ...
    public static final FluidObject VYNIL_CHLORIDE = register("vynil_chloride", new Color(23, 191, 152), FLUID_RL);
    public static final FluidObject POLYVYNIL_CHLORIDE = register("polyvynil_chloride", new Color(0, 138, 106), FLUID_RL);
    public static final FluidObject CHLOROMETHANE = register("chloromethane", new Color(234, 168, 173), FLUID_RL);
    public static final FluidObject BROMIDE = register("bromide", new Color(234, 168, 173), FLUID_RL);
    ...
    public static final FluidObject DISTILLED_WATER = register("distilled_water", new Color(2, 255, 228), FLUID_RL);
    ...
    public static final FluidObject BIOCRUDE = register("biocrude", new Color(47, 82, 37), FLUID_RL);
