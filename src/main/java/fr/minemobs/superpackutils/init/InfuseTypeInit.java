...
public class InfuseTypeInit {
    ...
    public static final RegistryObject<InfuseType> ICHOR_CRYSTAL = register("ichor_crystal", 0xFFa600);
    ...
    public static final RegistryObject<InfuseType> BLOOD_CRYSTAL = register("blood_crystal", 0xFC2003);
